...
- **设计文档**
  ...
  - [A2A Remote Agent Catalog 与 Delegation](design-a2a-remote-agent-tool.md) - 本地 Agent 通过 A2A 发现并委托 server Agent 的协作设计
...
| — | [A2A Remote Agent Catalog 与 Delegation](design-a2a-remote-agent-tool.md) | Local Agent discovers and delegates work to remote A2A Agent |

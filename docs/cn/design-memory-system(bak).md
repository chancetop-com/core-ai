...
| ④ Knowledge(Wiki)(考虑独立存储，支持提交) | `Memory.md` + `log.md` + `knowledge/*.md` | 持久化交叉引用知识网络 | T1/T2 Ingest | Agentic search（主要检索层） |
...
### T4 · Session Close（快速快照） 完善系统消息后处理

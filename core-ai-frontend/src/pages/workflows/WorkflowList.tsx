...
import { Plus, Trash2, History, Download, FileUp, Compass, Workflow as WorkflowIcon } from 'lucide-react';
...
export default function WorkflowList() {
  ...
  useEffect(() => {
    api.workflows.list(true)
      .then((mine) => setWorkflows(mine.workflows || []))
    ...
    <div style={{ padding: 24 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <button onClick={() => navigate('/workflows/explore')} style={btnSecondary}>

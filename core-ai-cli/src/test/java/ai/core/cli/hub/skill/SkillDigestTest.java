...
/**
 * Shared digest vectors — {@code ai.core.server.skill.SkillDigestTest} mirrors these
...
class SkillDigestTest {
    ...
    void resourceOrderDoesNotMatter() {
        var a = new SkillDigest.Resource("references/a.md", "A");
        var b = new SkillDigest.Resource("references/b.md", "B");

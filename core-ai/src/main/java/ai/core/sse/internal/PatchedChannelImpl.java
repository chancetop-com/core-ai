...
class PatchedChannelImpl<T> implements java.nio.channels.Channel, Channel<T>, Channel.Context {
    ...
    PatchedChannelImpl(HttpServerExchange exchange, StreamSinkChannel sink, PatchedServerSentEventContextImpl<T> serverSentEventContext, PatchedServerSentEventWriter<T> builder, String refId, RequestImpl request) {

...
//        queryParams.put("name", name);
        ...
        return executePromptRequest(url, name, cacheKey);
    }

    private LangfusePrompt executePromptRequest(String url, String name, String cacheKey) throws LangfusePromptException {
        try {

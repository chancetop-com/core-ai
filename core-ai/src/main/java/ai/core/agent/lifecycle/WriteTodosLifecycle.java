 ...
 * description:
 */
public class WriteTodosLifecycle extends AbstractLifecycle {
    ...
    @CoreAiMethod(name = "write_todos", description = WT_SYSTEM_PROMPT)
    ...
    public void afterAgentBuild(AgentBuilder agentBuilder) {
        String currentSystemPrompt = agentBuilder.getSystemPrompt() == null ? WT_SYSTEM_PROMPT : agentBuilder.getSystemPrompt() + "\n\n" + WT_SYSTEM_PROMPT;
        agentBuilder.systemPrompt(currentSystemPrompt);
        var currentTools = agentBuilder.getToolCalls();
        currentTools.add(Functions.from(this, "writeTodos").getFirst());
        agentBuilder.toolCalls(currentTools);
    }

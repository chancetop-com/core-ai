 ...
 * @author neo
 */
public final class PatchedHTTPClientBuilder {
    static {
    ...
    private final Logger logger = LoggerFactory.getLogger(PatchedHTTPClientBuilder.class);
...
//    }
    ...
    public PatchedHTTPClientBuilder connectTimeout(Duration connectTimeout) {
        this.connectTimeout = connectTimeout;
        return this;
    }

    // client level read/write timeout, request level timeout can be specified in HTTPRequest
    public PatchedHTTPClientBuilder timeout(Duration timeout) {
        this.timeout = timeout;
        return this;
    }

    public PatchedHTTPClientBuilder keepAlive(Duration keepAlive) {
        this.keepAlive = keepAlive;
        return this;
    }

    public PatchedHTTPClientBuilder userAgent(String userAgent) {
        this.userAgent = userAgent;
        return this;
    }

    public PatchedHTTPClientBuilder maxRetries(int maxRetries) {
        this.maxRetries = maxRetries;
        return this;
    }

    public PatchedHTTPClientBuilder retryWaitTime(Duration waitTime) {
        retryWaitTime = waitTime;
        return this;
    }

    public PatchedHTTPClientBuilder enableCookie() {
        enableCookie = true;
        return this;
    }

    public PatchedHTTPClientBuilder enableFallbackDNSCache() {
        enableFallbackDNSCache = true;
        return this;
    }

    public PatchedHTTPClientBuilder proxy(Proxy proxy) {
        this.proxy = proxy;
        return this;
    }

    public PatchedHTTPClientBuilder trustAll() {
        trustAll = true;
        return this;
    }

    public PatchedHTTPClientBuilder trust(String cert) {
        try {
            if (trustStore == null) {
    ...
    public PatchedHTTPClientBuilder clientAuth(String privateKey, String cert) {
        try {

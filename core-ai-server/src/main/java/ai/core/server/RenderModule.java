 ...
 * content-addressed, and resolve what a model can do from its admin-maintained gateway row. Extracted
 * from the drama pipeline, which was only its first consumer.
 * <p>
 * Loads after GatewayModule (MediaProvider, GatewayRoutingEngine) and ObjectStorageModule
 * (FileService) — core-ng resolves bind() eagerly.
 *
 * @author stephen
 */

...
public record PendingFile(String fileName, String container, String blobName, String fileId, String targetPath,
    ...
    public PendingFile(String fileName, String container, String blobName) {
        this(fileName, container, blobName, null, null, null);
    }

    public PendingFile(String fileName, String container, String blobName, String contentType) {
        this(fileName, container, blobName, null, null, contentType);
    }

    public PendingFile(String fileName, String container, String blobName, String fileId, String targetPath) {
        this(fileName, container, blobName, fileId, targetPath, null);
    }
}

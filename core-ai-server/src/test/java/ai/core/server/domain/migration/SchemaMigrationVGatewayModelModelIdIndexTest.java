...
class SchemaMigrationVGatewayModelModelIdIndexTest {
    @Test
    void createsModelIdIndex() {
        var migration = new SchemaMigrationVGatewayModelModelIdIndex();
        ...
        assertEquals(new BsonInt32(1), document.get("model_id"));
    }
}
